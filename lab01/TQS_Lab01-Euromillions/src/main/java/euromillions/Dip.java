...
public class Dip {
    ...
    static final Integer GENERATOR_NUMBERS = 49;
    static final Integer GENERATOR_STARS = 9;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < MAX_NUMBERS; ) {
            int candidate = generator.nextInt(GENERATOR_NUMBERS) + 1;
        ...
        for (int i = 0; i < MAX_STARS; ) {
            int candidate = generator.nextInt(GENERATOR_STARS) + 1;
